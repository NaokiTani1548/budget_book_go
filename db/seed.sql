...
INSERT INTO expenses (user_id, category_id, amount, description, expense_date, payment_method, memo) VALUES
                                                                                                         ...
                                                                                                         ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-0005-0005-0005-aaaaaaaaaaaa', 8500.00, '電気代',       '2026-05-01', 'CREDIT_CARD', '4月分');

-- 予定支出（未来日付）
INSERT INTO expenses (user_id, category_id, amount, description, expense_date, payment_method, memo) VALUES
                                                                                                         ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-0005-0005-0005-aaaaaaaaaaaa', 8500.00, '電気代',   '2026-06-01', 'CREDIT_CARD', '5月分'),
                                                                                                         ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-0002-0002-0002-aaaaaaaaaaaa', 6000.00, '定期代',   '2026-06-01', 'CREDIT_CARD', NULL),
                                                                                                         ('11111111-1111-1111-1111-111111111111', 'aaaaaaaa-0001-0001-0001-aaaaaaaaaaaa', 5000.00, '食費予算', '2026-06-30', 'CASH',        NULL);
...
-- 予定収入（未来日付）
INSERT INTO incomes (user_id, category_id, amount, description, income_date, memo) VALUES
                                                                                       ('11111111-1111-1111-1111-111111111111', 'bbbbbbbb-0001-0001-0001-bbbbbbbbbbbb', 280000.00, '5月給与', '2026-05-25', NULL),
                                                                                       ('11111111-1111-1111-1111-111111111111', 'bbbbbbbb-0001-0001-0001-bbbbbbbbbbbb', 280000.00, '6月給与', '2026-06-25', NULL),
                                                                                       ('11111111-1111-1111-1111-111111111111', 'bbbbbbbb-0002-0002-0002-bbbbbbbbbbbb',  30000.00, '副業',    '2026-06-15', 'B社');